    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Description 1", "Item 1", 487 },
                    { 2, 2, "Description 2", "Item 2", 325 },
                    { 3, 3, "Description 3", "Item 3", 237 },
                    { 4, 4, "Description 4", "Item 4", 676 },
                    { 5, 5, "Description 5", "Item 5", 799 },
                    { 6, 1, "Description 6", "Item 6", 704 }
                });
